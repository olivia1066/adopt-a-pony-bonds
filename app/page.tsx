          ...
          <div style={{
            ...
            <div>
              ...
              <div style={{ marginBottom: '24px', padding: '12px 16px', borderRadius: '12px', backgroundColor: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.06)' }}>
                ...
                <p style={{ fontSize: '18px', fontWeight: 800, color: '#00FFFF' }}>
                  €5,000 <span style={{ fontSize: '12px', fontWeight: 400, color: 'rgba(255,255,255,0.35)' }}>at end of month 36</span>
                </p>
              </div>
      ...
      <section style={{
        ...
        <div style={{ flex: '1', padding: '120px 96px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '48px' }}>
            {[
              { icon: '🛡️', title: 'Backed by real assets and long-term city contracts with low default risk.', desc: 'A fleet of e-bikes and scooters, made of steel and rubber, generating revenue under long-term contracts with French cities. This is infrastructure-backed lending with a brand people already trust and use everyday.' },
              { icon: '📈', title: 'High fixed returns as compared to classical investment platforms.', desc: '9.5% annual interest is significantly above what banks or most crowdfunding platforms offer today.' },
              { icon: '🏙️', title: 'Risk spread over hundreds of ebikes and scooters.', desc: "You don't invest in one vehicle, you invest in an entire fleet. Each Pony bike generates an average of €150/month in revenue. If one underperforms, the others cover it. That's how we protect your returns." },
