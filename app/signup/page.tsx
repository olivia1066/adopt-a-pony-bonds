...
function SignupForm() {
  ...
  async function handleSignup() {
    ...
    try {
      ...
      // Store redirect for after email confirmation
      if (redirect !== '/dashboard') {
        localStorage.setItem('postSignupRedirect', redirect)
      }
            ...
            {redirect.includes('/investir') && (
              <div className="rounded-2xl p-4 text-sm"
                ...
                <p style={{ color: 'rgba(255,255,255,0.6)' }}>
                  💡 Once your email is confirmed, sign in and you'll be taken directly to your investment.
                </p>
              </div>
            )}
